<%@ Page Title="" Language="C#" MasterPageFile="~/User Pages/User.Master" AutoEventWireup="true" CodeBehind="ViewTransactions.aspx.cs" Inherits="ASPProject.User_Pages.WebForm4" %>
<asp:Content ID="View_Transactions" ContentPlaceHolderID="Body" runat="server">
    <div style="margin-left:12.5%; margin-top:10%; width:75%">

        <asp:GridView ID="userTransactions" runat="server" AutoGenerateColumns="False" DataKeyNames="transaction_id" DataSourceID="GMBDataSource">
            <Columns>
                <asp:BoundField DataField="transaction_id" HeaderText="Transaction ID" InsertVisible="False" ReadOnly="True" SortExpression="transaction_id" />
